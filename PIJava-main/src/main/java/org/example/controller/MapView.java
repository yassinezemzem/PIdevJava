...
public class MapView extends StackPane {
    ...
    private void setupMap() {
        ...
        java.util.List<org.example.entities.CentreDeDon> centres = new org.example.service.CentreDeDonService().getAllCentres();
        for (org.example.entities.CentreDeDon centre : centres) {
            centersJS.append(
