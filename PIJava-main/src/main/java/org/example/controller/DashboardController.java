...
public class DashboardController {
    ...
    @FXML
    private Button btnAddExMentale;

    @FXML
    private Button btnAddTherapie;

    @FXML
    private Button btnExMentale;
    ...
    @FXML
    void gotoAddExMentale(ActionEvent event) {
        loadUI("/ajouter-modifier-exercicemntal-admin.fxml");
    }

    @FXML
    void gotoAddTherapie(ActionEvent event) {
        loadUI("/ajouter-modifier-therapie-admin.fxml");
    }

    @FXML
    void gotoExMentale(ActionEvent event) {
        loadUI("/afficher-exercicemntal-admin.fxml");
    }

    @FXML
    void gotoTherapie(ActionEvent event) {
        loadUI("/afficher-therapie-admin.fxml");
