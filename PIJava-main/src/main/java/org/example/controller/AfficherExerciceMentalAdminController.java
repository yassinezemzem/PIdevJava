...
public class AfficherExerciceMentalAdminController {
    ...
    public void initialize() {
        refresh();
    } //nlanciha ki yet7al ecran w wa7adha trefrshi

    @FXML
    void modifier(ActionEvent event) { //t7el fenetre jdida namel fiha modif
        ...
        if (selected != null) {
            try {
                ...
                stage.setOnHidden(e -> refresh()); //yrefreshi wahdou ki nsakar fenetre bech ki n7el nalkaha refreshed
                stage.show();
            } catch (IOException e) {
