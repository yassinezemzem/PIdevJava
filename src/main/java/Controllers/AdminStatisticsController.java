...
public class AdminStatisticsController {
    ...
    private void loadStatistics() {
        ...
        List<Produit> produits = produitService.readAll(); // Changed from recuperer to readAll
        List<Categorie> categories = categorieService.readAll(); // Changed from recuperer to readAll
